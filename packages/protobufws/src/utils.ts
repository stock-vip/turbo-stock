...
export const buffer2array = (buffer: Uint8Array) => {
	let values = [];
...
export const bufferAdd = (a: Uint8Array, b: Uint8Array) =>{
	return new Uint8Array([...buffer2array(a), ...buffer2array(b)]);
}

export const buffer2str = (a: Uint8Array) => String.fromCharCode(...[...buffer2array(a)]);
