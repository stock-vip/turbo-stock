...
(function(global, factory) { /* global define, require, module */
    ...
    $root.stockService = (function() {
         ...
         * @memberof stockService
         * @typedef getStockPricestreamCallback
         * @type {function}
         * @param {Error|null} error Error, if any
         * @param {stockResponse} [response] stockResponse
         */
         ...
         * @function getStockPricestream
         * @memberof stockService
         * @instance
         * @param {IstockRequest} request stockRequest message or plain object
         * @param {stockService.getStockPricestreamCallback} callback Node-style callback called with the error, if any, and stockResponse
         * @returns {undefined}
         * @variation 1
         */
        Object.defineProperty(stockService.prototype.getStockPricestream = function getStockPricestream(request, callback) {
            return this.rpcCall(getStockPricestream, $root.stockRequest, $root.stockResponse, request, callback);
        }, "name", { value: "getStockPricestream" });
